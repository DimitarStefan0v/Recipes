namespace Recipes.Common.Constants
{
    public static class ContactErrorMessages
    {
        ...
        public const string ContentRequired = "Съдържание към съобщението е задължително";

        public const string ContentLength = "Съдържанието трябва да е с дължина от поне 10 букви";
    }
}
